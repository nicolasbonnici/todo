	        ...
	        <tr{% if oTodo.deadline > current_timestamp %} class="danger blackFontColor"{% endif %}>
	            ...
	            <td class="text-center">
					<div class="btn-group">
					  ...
					  <a href="#modal-todo" class="ui-sendxhr btn btn-lg btn-danger" data-url="/todo/home/delete/" data-selector="#modal-todo-content" data-toggle="modal" data-pk="{{oTodo.idtodo}}" title="{{tr['delete']}}">
