...
<link
    ...
    rel="stylesheet">
<link
    href="/lib/plugins/summernote/css/summernote.css"
    rel="stylesheet">
<link
    href="/lib/plugins/summernote/css/summernote-bs3.css"
    rel="stylesheet">
    ...
    <div class="col-md-12 column">
        <div class="page-header">
            <h1 class="showOnHover">
                <img
                    src="/lib/bundles/todo/icon.png"
                    alt="App icon" />Todo! <small class="targetToShow">1.0</small>
            </h1>
        </div>
    </div>
    <div class="col-md-12 column">
        <div class="btn-group btn-group-lg">
            ...
            <button
                ...
                data-selector="#modal-create-content"
                role="button"
                data-toggle="modal">
            ...
            <button
                ...
                data-selector="#modal-todo-content"
                role="button"
                data-toggle="modal">
