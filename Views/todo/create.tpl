...
<div id="modal-create-content" class="modal-body">
    <form role="form" id="newTodoForm" action="/crud/create/" data-entity="Todo" data-view="crud/create.tpl"
        ...
        <div class="form-group">
            <label>Titre du Todo</label> <input type="text" name="label" class="form-control input-lg"
                placeholder="Entrez le titre de votre post" value="{% if title|Exists %}{{title}}{% endif %}" />
        </div>
        <div class="form-group">
            <label>Deadline</label>
            <div class="input-group date ui-datetimepicker">
                <input type="text" class="form-control input-lg" placeholder="La date butoire de ce todo" /> <span
